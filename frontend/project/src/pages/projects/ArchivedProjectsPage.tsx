...
import { useArchivedProjects } from '../../services/project-hooks';
...
export function ArchivedProjectsPage() {
  ...
  const { data: projects, isLoading, isError, error } = useArchivedProjects(wsId || undefined, deptId || undefined);
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-body text-text-secondary">Restore or permanently remove archived projects.</p>
      </div>
