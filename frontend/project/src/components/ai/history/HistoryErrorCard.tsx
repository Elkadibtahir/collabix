...
export function HistoryErrorCard({ message, onRetry, onDismiss }: HistoryErrorCardProps) {
  return (
    <div
    ...
    >
      ...
      <div>
        <h3 className="text-section font-semibold text-text-primary">Unable to load history</h3>
