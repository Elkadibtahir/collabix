...
public class MarketingCampaignSpecification {
    ...
    public static Specification<MarketingCampaign> withFilter(UUID departmentId, MarketingCampaignSearchCriteria criteria) {
        return (root, query, cb) -> {
            ...
            if (criteria != null) {
                ...
                if (criteria.getCampaignType() != null) {
                    predicates.add(cb.equal(root.get("campaignType"), criteria.getCampaignType()));
                }
